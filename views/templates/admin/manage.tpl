	  ...
	  <table class="table">
		...
		<tbody>
		  {foreach $filters_templates as $template}
			<tr>
			  <td class="center">{$template['id_gc_facetedsearch_filter']}</td>
				...
				{if empty($limit_warning)}
				  <div class="btn-group-action">
					<div class="btn-group pull-right">
					  <a href="{$current_url}&amp;edit_filters_template=1&amp;id_gc_facetedsearch_filter={(int)$template['id_gc_facetedsearch_filter']}" class="btn btn-default">
					  ...
					  <ul class="dropdown-menu">
						<li>
						  <a href="{$current_url}&amp;deleteFilterTemplate=1&amp;id_gc_facetedsearch_filter={(int)$template['id_gc_facetedsearch_filter']}"
...
<div class="panel">
  ...
  <form action="{$current_url}" method="post" class="form-horizontal">
	<div class="form-group">
	  ...
	  <div class="col-lg-9">
		<span class="switch prestashop-switch fixed-width-lg">
		  <input type="radio" name="gc_layered_cache_enabled" id="gc_layered_cache_enabled_on" value="1"{if $cache_enabled} checked="checked"{/if}>
		  <label for="gc_layered_cache_enabled_on" class="radioCheck">
			<i class="color_success"></i> {l s='Yes' d='Admin.Global'}
		  </label>
		  <input type="radio" name="gc_layered_cache_enabled" id="gc_layered_cache_enabled_off" value="0"{if !$cache_enabled} checked="checked"{/if}>
		  <label for="gc_layered_cache_enabled_off" class="radioCheck">
	...
	<div class="form-group">
	  ...
	  <div class="col-lg-9">
		<span class="switch prestashop-switch fixed-width-lg">
		  <input type="radio" name="gc_layered_show_qties" id="gc_layered_show_qties_on" value="1"{if $show_quantities} checked="checked"{/if}>
		  <label for="gc_layered_show_qties_on" class="radioCheck">
			<i class="color_success"></i> {l s='Yes' d='Admin.Global'}
		  </label>
		  <input type="radio" name="gc_layered_show_qties" id="gc_layered_show_qties_off" value="0"{if !$show_quantities} checked="checked"{/if}>
		  <label for="gc_layered_show_qties_off" class="radioCheck">
			<i class="color_danger"></i> {l s='No' d='Admin.Global'}
		  </label>
		  <a class="slide-button btn"></a>
		</span>
	...
	<div class="form-group">
	  ...
	  <div class="col-lg-9">
		<span class="switch prestashop-switch fixed-width-lg">
		  <input type="radio" name="gc_layered_full_tree" id="gc_layered_full_tree_on" value="1"{if $full_tree} checked="checked"{/if}>
		  <label for="gc_layered_full_tree_on" class="radioCheck">
			<i class="color_success"></i> {l s='Yes' d='Admin.Global'}
		  </label>
		  <input type="radio" name="gc_layered_full_tree" id="gc_layered_full_tree_off" value="0"{if !$full_tree} checked="checked"{/if}>
		  <label for="gc_layered_full_tree_off" class="radioCheck">
			<i class="color_danger"></i> {l s='No' d='Admin.Global'}
		  </label>
		  <a class="slide-button btn"></a>
		</span>
	...
	<div class="form-group">
	  ...
	  <div class="col-lg-9">
		<span class="switch prestashop-switch fixed-width-lg">
		  <input type="radio" name="gc_layered_filter_by_default_category" id="gc_layered_filter_by_default_category_on" value="1"{if $filter_by_default_category} checked="checked"{/if}>
		  <label for="gc_layered_filter_by_default_category_on" class="radioCheck">
			<i class="color_success"></i> {l s='Yes' d='Admin.Global'}
		  </label>
		  <input type="radio" name="gc_layered_filter_by_default_category" id="gc_layered_filter_by_default_category_off" value="0"{if !$filter_by_default_category} checked="checked"{/if}>
		  <label for="gc_layered_filter_by_default_category_off" class="radioCheck">
			<i class="color_danger"></i> {l s='No' d='Admin.Global'}
		  </label>
		  <a class="slide-button btn"></a>
		</span>
	...
	<div class="form-group">
	  ...
	  <div class="col-lg-9">
		<input type="text" name="gc_layered_filter_category_depth" value="{if $category_depth !== false}{$category_depth}{else}1{/if}" class="fixed-width-sm" />
	  </div>
		<div class="col-lg-9 col-lg-offset-3">
		<div class="help-block">
	...
	<div class="form-group">
	  ...
	  <div class="col-lg-9">
		<span class="switch prestashop-switch fixed-width-lg">
		  <input type="radio" name="gc_layered_filter_price_usetax" id="gc_layered_filter_price_usetax_on" value="1"{if $price_use_tax} checked="checked"{/if}>
		  <label for="gc_layered_filter_price_usetax_on" class="radioCheck">
			<i class="color_success"></i> {l s='Yes' d='Admin.Global'}
		  </label>
		  <input type="radio" name="gc_layered_filter_price_usetax" id="gc_layered_filter_price_usetax_off" value="0"{if !$price_use_tax} checked="checked"{/if}>
		  <label for="gc_layered_filter_price_usetax_off" class="radioCheck">
			<i class="color_danger"></i> {l s='No' d='Admin.Global'}
		  </label>
		  <a class="slide-button btn"></a>
		</span>
	...
	<div class="form-group">
	  ...
	  <div class="col-lg-9">
		<span class="switch prestashop-switch fixed-width-lg">
		  <input type="radio" name="gc_layered_filter_price_rounding" id="gc_layered_filter_price_rounding_on" value="1"{if $price_use_rounding} checked="checked"{/if}/>
		  <label for="gc_layered_filter_price_rounding_on" class="radioCheck">
			<i class="color_success"></i> {l s='Yes' d='Admin.Global'}
		  </label>
		  <input type="radio" name="gc_layered_filter_price_rounding" id="gc_layered_filter_price_rounding_off" value="0"{if !$price_use_rounding} checked="checked"{/if}/>
		  <label for="gc_layered_filter_price_rounding_off" class="radioCheck">
			<i class="color_danger"></i> {l s='No' d='Admin.Global'}
		  </label>
		  <a class="slide-button btn"></a>
		</span>
	...
	<div class="form-group">
	  ...
	  <div class="col-lg-9">
		<span class="switch prestashop-switch fixed-width-lg">
		  <input type="radio" name="gc_layered_filter_show_out_of_stock_last" id="gc_layered_filter_show_out_of_stock_last_on" value="1"{if $show_out_of_stock_last} checked="checked"{/if}/>
		  <label for="gc_layered_filter_show_out_of_stock_last_on" class="radioCheck">
			<i class="color_success"></i> {l s='Yes' d='Admin.Global'}
		  </label>
		  <input type="radio" name="gc_layered_filter_show_out_of_stock_last" id="gc_layered_filter_show_out_of_stock_last_off" value="0"{if !$show_out_of_stock_last} checked="checked"{/if}/>
		  <label for="gc_layered_filter_show_out_of_stock_last_off" class="radioCheck">
			<i class="color_danger"></i> {l s='No' d='Admin.Global'}
		  </label>
		  <a class="slide-button btn"></a>
		</span>
  ...
  <div class="form-group">
    ...
    <div class="col-lg-9">
    <span class="switch prestashop-switch fixed-width-lg">
      <input type="radio" name="gc_use_jquery_ui_slider" id="gc_use_jquery_ui_slider_on" value="1"{if $use_jquery_ui_slider} checked="checked"{/if}>
      <label for="gc_use_jquery_ui_slider_on" class="radioCheck">
      <i class="color_success"></i> {l s='Yes' d='Admin.Global'}
      </label>
      <input type="radio" name="gc_use_jquery_ui_slider" id="gc_use_jquery_ui_slider_off" value="0"{if !$use_jquery_ui_slider} checked="checked"{/if}>
      <label for="gc_use_jquery_ui_slider_off" class="radioCheck">
      <i class="color_danger"></i> {l s='No' d='Admin.Global'}
      </label>
      <a class="slide-button btn"></a>
    </span>
	...
	<div class="form-group">
		...
		<div class="col-lg-9">
			<select class="form-control fixed-width-xxl" name="gc_layered_default_category_template" id="gc_layered_default_category_template">
				<option value="0" {if empty($default_category_template)} selected="selected" {/if}>{l s='None' d='Admin.Global'}</option>
				{foreach $filters_templates as $template}
					<option value="{$template['id_gc_facetedsearch_filter']}" {if $default_category_template == $template['id_gc_facetedsearch_filter']} selected="selected" {/if}>{$template['name']}</option>
				{/foreach}
			</select>
		</div>
		<div class="col-lg-9 col-lg-offset-3">
...
<script type="text/javascript">
  {if isset($GC_LAYERED_INDEXED)}var GC_LAYERED_INDEXED = {$GC_LAYERED_INDEXED};{/if}
  var token = '{$token}';
  var id_lang = {$id_lang};
