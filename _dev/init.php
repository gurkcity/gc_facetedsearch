...
$stringTo = [
    ($prefix ? strtoupper($prefix) . '_' : '') . $moduleTitlePre . $moduleTitlePost,
    ucfirst($prefix) . $moduleTitlePre . $moduleTitlePost,
    $moduleTitlePre . $moduleTitlePost,
    ($prefix ? $prefix . '_' : '') . strtolower($moduleTitlePre . $moduleTitlePost),
    trim(($prefix ? strtoupper($prefix) . ' ' : '') . $moduleTitlePre . ' ' . $moduleTitlePost),
    $moduleTitlePre . ' ' . $moduleTitlePost,
...
$filesystem->copy($moduleDir . 'translations' . DIRECTORY_SEPARATOR . 'de-DE' . DIRECTORY_SEPARATOR . 'ModulesGcmoduletemplateAdmin.de-DE.xlf', $moduleDir . 'translations' . DIRECTORY_SEPARATOR . 'de-DE' . DIRECTORY_SEPARATOR . 'Modules' . $stringTo[6] . 'Admin.de-DE.xlf');
$filesystem->copy($moduleDir . 'translations' . DIRECTORY_SEPARATOR . 'de-DE' . DIRECTORY_SEPARATOR . 'ModulesGcmoduletemplateShop.de-DE.xlf', $moduleDir . 'translations' . DIRECTORY_SEPARATOR . 'de-DE' . DIRECTORY_SEPARATOR . 'Modules' . $stringTo[6] . 'Shop.de-DE.xlf');
...
if (!$isPayment) {
    ...
    $filesystem->remove($moduleDir . 'views/css/front/payment.css');
    $filesystem->remove($moduleDir . 'views/img/os.gif');
    $filesystem->remove($moduleDir . 'views/img/os_neworder.gif');
    $filesystem->remove($moduleDir . 'views/img/payment.png');
    $filesystem->remove($moduleDir . 'views/img/payment_orig.png');
    $filesystem->remove($moduleDir . 'views/js/front/payment.js');
